  ...
  return NextResponse.json({
    ...
    alertPolicy: { version: ALERT_POLICY_VERSION, minimumNarrative: MIN_NARRATIVE_SCORE,
      ...
      observation: { minimumActivityScore: 70, minimumHolders: 60,
        ...
        mandatory: ["fresh core evidence", "revoked authorities", "insider graph", "holder and creator distribution", "market activity", "no known hard risk", "no detected name copy"] },
